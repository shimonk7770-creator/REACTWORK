...
- **בנק שאלות החידון** מוגבל ל-~15–20 שאלות לרוב הפרשות (מקור abc770.org; פרשת דברים הורחבה ל-36 שאלות בשלב 37 כדי לפתור חזרתיות בין רמות הקושי — שאר 34 הפרשות עדיין בגודל המקורי); ראה שלב 22 ב-[tasks.md](tasks.md) לגבי ניסיון לבדוק מקור הרחבה נוסף.
...
- [`ARCHITECTURE.md`](ARCHITECTURE.md) — פירוט טכני מעמיק: היררכיית קומפוננטים, זרימת נתונים, אלגוריתמים מרכזיים, החלטות ארכיטקטוניות
